...
# learning_rates = [0.4, 0.2, 1E-0, 1E-1, 1E-2, 1E-3, 1E-5, 1E-7]
...
def build_model(X_train, loss = 'mse', optimizer = 'adam'): #remove dropouts, layers. units as params
    ...
    # 1st LSTM layer
    grid_model.add(LSTM(units=neurons, return_sequences=True, input_shape=(X_train.shape[1], X_train.shape[2]))) # (30,4)
